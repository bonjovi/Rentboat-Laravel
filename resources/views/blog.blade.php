...
@section('content')
    ...
    <div class="blog">
        <div class="container">
            <form action="{{ route('blog.search', app()->getLocale()) }}" method="GET">
                @csrf
            ...
            <div class="blog-content">
                    ...
                    <div class="blog-top flex">
                        ...
                        @foreach($posts as $post)
                            <div class="main-news" style="background-image: url({{ Storage::url('/'.$post->image ) }});">
                        ...
                        <div class="right">
                            ...
                            @foreach($posts as $post)
                                <div class="news-item">
                                    ...
                                    <div class="news-item-img"><img src="{{ Storage::url('/'.$post->image ) }}" alt=""></div>
                    ...
                    @foreach($posts as $post)
                        <div class="col">
                            <div class="news-item">
                                ...
                                <div class="news-item-img"><img src="{{ Storage::url('/'.$post->image ) }}" alt=""></div>
                                <div class="news-item-caption">
                                    <h4><a href="/{{ Config::get('app.locale') }}/blog/{{ $post->slug }}">{{ $post->title }}</a></h4>
                                    <p>Какой то краткий текст о том почему нужно выбирать себе яхту для путешествия</p>
                                </div>
                            </div>
                        </div>
